<template>
  <div class="my-order">
    ...
    <el-dialog title="胖猫客服" :visible.sync="serviceVisible" width="30%" style="padding: 0 20px 0">
  ...
  export default {
    ...
    data() {
      ...
      return{
        ...
        Parcel: ['胖猫物流','邮政快递','中通快递','圆通快递','百世快递'],
    ...
    methods:{
      ...
      payment(orderNo,orderTime,productName,payPrice,productType){
        if(this.isTimeOut(orderTime)){
          ...
          let orderName = '胖猫商城-'+productType+'-'+productName+'支付订单';
