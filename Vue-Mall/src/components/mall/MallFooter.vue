    ...
    <div class="container">
      ...
      <div class="footer-copyright">
        <div class="clearfix" style="width: 32%;min-width: 456px;margin: 0 auto;padding: 10px 0">
          <el-image src="https://mymall-pictures.oss-cn-beijing.aliyuncs.com/images/img/pmallLogoB.png"></el-image>
          <div class="copyright">胖猫商城公司版权所有 ©2020-{{new Date().getFullYear()}}</div>
        </div>
      </div>
    </div>
  </div>
