      ...
      <div class="mall-container clearfix" v-if="productInfo">
        <ul v-if="productInfo.length!==0">
          <li v-for="(product,index) in this.productInfo" :key="index" @click="buy(product.productId)">
            ...
            <div class="pro-con">
              <span :title="product.productName" v-html="product.productName" class="name">{{product.productName}}</span>
              <span v-html="product.productDescribe" class="desc">{{product.productDescribe}}</span>
